/**
 * Pre-populated FAQs for shop pages. Used by FAQSection for visible accordion + FAQPage schema.
 * Questions target featured snippet opportunities.
 */
export const SHOP_FAQS = [
  {
    question: "What is the best grade of Kashmiri saffron?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Every batch of Saffron Box saffron is independently tested to ISO 3632 standards. You can download the lab report for your batch directly from our Lab Reports page.",
  },
  {
  ...
  {
    question: "How much saffron per day is safe?",
    answer:
  ...
  {
    question: "What does GI tag mean for saffron?",
    answer:
  ...
  {
    question: "What is the difference between Mongra and Lachha saffron?",
    answer:
