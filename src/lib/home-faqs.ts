...
export const HOME_FAQS = [
  {
    ...
    answer:
      "Buy pure Kashmiri Mongra kesar directly from Saffron Town at www.saffron.town/shop/saffron. Every order is farm-direct from Pampore, GI-tagged, Grade A++ Mongra, and ships across India with a money-back purity guarantee. No middlemen, no old stock.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. Saffron Town saffron is grown in Pampore, Kashmir — the GI-tagged saffron region — and sold as Grade A++ Mongra, farm-direct with no middlemen. We do not certify every retail batch by lab, but independent ISO 3632 testing is available on request for bulk orders over 1 kg. We also offer a full money-back guarantee if adulteration is ever found.",
  },
  {
