...
export async function POST(request: Request) {
  ...
  // ── 1. Extract and validate Razorpay tokens ──
  ...
  if (
    ...
    console.warn("[razorpay] signature mismatch", { razorpayOrderId });
    return NextResponse.json(
  ...
  // ── 4. Create DB order (payment already verified) ──
  try {
