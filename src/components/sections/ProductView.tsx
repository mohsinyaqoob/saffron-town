        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-24">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-8 pt-8 border-t border-secondary-border/20">
                <div className="mb-6">
                    <h3 className="text-sm font-bold text-text-primary uppercase tracking-widest mb-3">Select Size</h3>
            ...
            <div className="mt-8 flex items-center gap-8 py-6 border-t border-b border-secondary-border/10">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold uppercase tracking-tighter text-text-primary">Garanteed Pure</span>
                </div>
                <div className="flex items-center gap-2">
                    <svg className="h-5 w-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
