          ...
          <div className="flex flex-col justify-center">
                  ...
                  <>
                    <div className="flex items-center gap-1 text-primary/80 mb-1">
                      {[...Array(5)].map((_, i) => (
                        <svg
                          key={i}
                          className={`h-4 w-4 ${i < Math.floor(product.rating) ? "fill-current" : "fill-secondary-border/30 text-secondary-border/30"}`}
                          viewBox="0 0 20 20"
                        >
            ...
            <div className="mt-4 flex flex-col gap-4 sm:flex-row">
              ...
              <Button
                ...
                variant="outline"
                className={`flex-none aspect-square p-0 w-[4.5rem] h-[4.5rem] rounded-full transition-all ${isFavorite(product.id) ? "border-primary bg-primary/5 text-primary" : "border-secondary-border/30 text-secondary hover:bg-surface-muted hover:text-primary"}`}
              >
                <svg
                  className="h-6 w-6"
